...
def _get_analysis_result_from_response(response: SendMessageResponse) -> dict[str, Any]:
    """
...
def _validate_response(response: SendMessageResponse) -> bool:
    """
...
if __name__ == "__main__":
    ...
    async def main():
        ...
        analysis_result: dict[str, Any] = _get_analysis_result_from_response(response)
