...
Provides a web interface for RAG queries, UI-to-code from images, and prompt-to-HTML generation.
"""
...
def get_rag_pipeline():
    ...
    """
    try:
        # Lazy imports to avoid startup overhead & circular imports
        ...
        # Load documents from corpus (optional - PDFs for general knowledge)
